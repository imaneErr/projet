      ...
      children: [
        Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Text('Details trainers'),
          ),
                  ...
                  Container(
                    child: Column(
                      children: [
                        CircleAvatar(
                            radius: 70,
                            backgroundImage:AssetImage("${GlobalParameter.trainners[(widget.idProfile)-1].profile}"),
                        ),

                        Text(
                          '${GlobalParameter.trainners[(widget.idProfile)-1].name}',
                          style: TextStyle(
                            color: Colors.black,
                        ...
                        Text(
                          '${GlobalParameter.trainners[(widget.idProfile)-1].job}',
                          style: TextStyle(
                            fontSize: 20,
